        ...
        <div className="space-y-4 py-2 sm:py-4">
          ...
          {user && (
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className={cn("font-medium", isMobile ? "text-base" : "text-sm")}>个人信息</h3>
              </div>
              <div className="pl-4 space-y-3">
                <div className={cn("grid items-center gap-3", isMobile ? "grid-cols-[auto_1fr] items-center" : "grid-cols-4")}>
                  {isMobile ? (
                    <>
                      <Label className={cn(isMobile ? "text-base" : "text-sm")}>头像</Label>
                      <div className="flex items-center gap-2">
                        <UserAvatar
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <h3 className={cn("font-medium", isMobile ? "text-base" : "text-sm")}>外观设置</h3>
            </div>
            <div className="pl-4 space-y-3">
              {/* 主题设置 */}
              ...
              <div className={cn("grid items-center gap-3", isMobile ? "grid-cols-[auto_1fr]" : "grid-cols-4")}>
                {isMobile ? (
                  <>
                    <Label htmlFor="fontFamily" className={cn(isMobile ? "text-base" : "text-sm")}>字体</Label>
              ...
              <div className={cn("grid items-center gap-3", isMobile ? "grid-cols-[auto_1fr]" : "grid-cols-4")}>
                {isMobile ? (
                  <>
                    <Label htmlFor="fontSize" className={cn(isMobile ? "text-base" : "text-sm")}>字号</Label>
          ...
          {user && (
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className={cn("font-medium", isMobile ? "text-base" : "text-sm")}>同步设置</h3>
              </div>
              <div className="pl-4 space-y-3">
                <div className={cn("grid items-center gap-3", isMobile ? "grid-cols-[auto_1fr]" : "grid-cols-4")}>
                  {isMobile ? (
                    <>
                      <Label htmlFor="sync-interval" className={cn(isMobile ? "text-base" : "text-sm")}>同步间隔</Label>
